...
_lcg()
{
    ...
    subcommands="annotate ap correlations cv ecode experiment extracellular extract-kernels fclamp fi fopt help impedance kernel ltpltd mkdir non-rt ou output pspopt pulse pulses pulses-pair pulses-with-level Rin ramp rate-steps rcwrite sinusoids spontaneous steps steps-with-bg stimgen stimulus tau test-daq vcclamp vi zap zero"
    case "$prev" in
	"lcg"|"help")
